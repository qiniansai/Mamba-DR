"""
Domain Knowledge Dictionary for Medical Image Text Encoding

This module contains expert knowledge descriptions for various
fundus image conditions, useful for enhancing text embeddings
